...
import { clsFacturaInmuebles, clsItmFacturaInmuebles, clsTotalesFac } from './clsHOR004.class';
import { HOR00401Component } from './HOR00401/HOR00401.component';
import { clsPropietarios } from '../HOR002/clsHOR002.class';
import { HOR00402Component } from './HOR00402/HOR00402.component';
...
@Component({
  selector: 'app-HOR004',
  templateUrl: './HOR004.component.html',
  styleUrls: ['./HOR004.component.css'],
  standalone: true,
  imports: [MatTabsModule, DxLoadPanelModule, DxFormModule, DxSelectBoxModule,
            ...
            HOR00401Component, HOR00402Component, FiltrobusqComponent, GeninformesComponent,
            HOR00101Component
    ]
})
export class HOR004Component {
  ...
  FFacturas: clsFacturaInmuebles;
  DItemsFacturas: clsItmFacturaInmuebles[] = [];
  DTarifas: any = [];
  DDocumentos: any;
  DPeriodos: any;
  DTotales: clsTotalesFac[] = [];
  ...
  ngOnInit(): void {
    ...
    this.FFacturas = new clsFacturaInmuebles;
    this.FFacturas.TIPO = 'Masiva';
      ...
      case "r_numreg":
        ...
        var prmRep = { ...operMenu.operacion, 
                         ...
                         QFiltro: (operMenu.operacion.registro === 'todos') 
                                   ? this.QFiltro 
                                   : " PREFACTURA.ID_DOCUMENTO = '"+this.FFacturas.ID_DOCUMENTO+"' AND PREFACTURA.CONSECUTIVO = "+this.FFacturas.CONSECUTIVO
                        };
        ...
        if (operMenu.operacion.modo === 'email') {
          ...
          var prmRep = { ...operMenu.operacion, 
                        ...
                        nombre: this.FFacturas.ID_DOCUMENTO,
                        email:  '',
                        template,
                        replacements: '',
                        dataSource: this.FFacturas
                      };
          this.eventsSubjectInformes.next(prmRep);
        }
				break;
  ...
  opPrepararNuevo(): void {
    ...
    this.FFacturas.ESTADO = 'REGISTRADO';
    this.FFacturas.USUARIO = this.prmUsrAplBarReg.usuario;
    this.FFacturas.TIPO_VENTA = 'CONTADO';
  }
  ...
  async opPrepararModificar()  {
    ...
    this.activarEdicion('activo');
    const prm = { ID_CLIENTE: this.FFacturas.ID_DOCUMENTO, accion: 'integridad referencial' };
  ...
  ValidaDatos(Accion: string): boolean {
    var msg = '';
    if (Accion === "requerido"){
      if(this.FFacturas.ID_DOCUMENTO === '') msg += 'Documento ,';
      if(this.FFacturas.TIPO === '') msg += 'Tipo de facturación ,';
      if(this.FFacturas.ID_CLIENTE === '' && this.FFacturas.TIPO == 'Individual' ) msg += 'Falta cliente! ,';
      if(this.FFacturas.FACTURA === '' && this.FFacturas.TIPO == 'Individual' ) msg += 'No hay consecutivo de factura! ,';
      if (msg !== '') {
  ...
  opPrepararGuardar(accion: string): void {
    ...
    const prmDatosGuardar = { FACTURA: this.FFacturas, 
                              ITM_FACTURA: this.DItemsFacturas, 
                              USUARIO: this.prmUsrAplBarReg.usuario
                             }
      ...
      { next: (resp) => {
        ...
        else
        {
          ...
          if (this.mnuAccion === 'new'){
            this.QFiltro = " PREFACTURA.ID_DOCUMENTO = '"+this.FFacturas.ID_DOCUMENTO+"' AND " +
                           " PREFACTURA.CONSECUTIVO = "+this.FFacturas.CONSECUTIVO
            this.prmUsrAplBarReg = {
              ...this.prmUsrAplBarReg,
              error: "",
              accion: "r_navegar",
        ...
        .subscribe((data: any) => {
          ...
          if (datares[0].ErrMensaje === '') {
            ...
            if ( datares??'' != '' ) {
              ...
              this.FFacturas = datares[0];
              this.QFiltro = datares[0].QFILTRO;
              
              
              // Acondiciona peril tributario
              // if (this.FFacturas.PERFIL_TRIBUTARIO??'' !== '') {
              //   this.FFacturas.PERFIL_TRIBUTARIO = this.FFacturas.PERFIL_TRIBUTARIO.split('|');
              // }
  ...
  AccionEliminar(): void {
    ...
    const prm = { ACREEDORES: { ID_CLIENTE: this.FFacturas.ID_DOCUMENTO } };
    this._sdatos
  ...
  opIrARegistro(accion: string): void {
    ...
    switch (accion) {
      case "r_primero":
        ...
        if (this.VDatosReg.length != 0){
          this.FFacturas = JSON.parse(JSON.stringify(this.VDatosReg[0]));
          this._sbarreg.setObsMenuReg(this.prmUsrAplBarReg);
        }
        break;
      ...
      case "r_anterior":
        ...
        this.FFacturas = JSON.parse(JSON.stringify(this.VDatosReg[this.prmUsrAplBarReg.r_numReg - 1]));
        this._sbarreg.setObsMenuReg(this.prmUsrAplBarReg);
        break;
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (this.FFacturas.TIPO == 'Masiva' )
          this.eventsSubjectItems.next({ operacion: 'consulta',
                                        documento: this.FFacturas.DOCUMENTO
                                      });
        else {
          ...
          this.DTotales = this.FFacturas.TOTALES;
        }
  ...
  opBlanquearForma(): void {
    ...
    this.DItemsFacturas = [];
    this.FFacturas_prev = JSON.parse(JSON.stringify(this.FFacturas));
    this.borderStyle = "none";
  ...
  async ValideExistencia(e: any) {
    ...
    if (this.mnuAccion === 'update' && this.FFacturas_prev.ID_DOCUMENTO === e.value) {
      return (true);
    }
  ...
  onRespuestaCrearCliente(e: any) {
    ...
    if (e.accion === 'aceptar') {
      ...
      // Selecciona cliente
      this.FFacturas.ID_CLIENTE = e.data.ID_CLIENTE;
      this.FFacturas.NOMBRE = e.data.NOMBRE+(' '+e.data.NOMBRE2).trimEnd()+' '+e.data.APELLIDO+(' '+e.data.APELLIDO2).trimEnd();
    ...
    if (e.value === 'Individual') {
      ...
      this._sdatos
        ...
        .subscribe((data: any) => {
          ...
          this.FFacturas.FACTURA = res[0].FACTURA;
        });
      ...
      this.FFacturas.TIPO_VENTA = 'CREDITO';
  ...
  onSeleccPeriodo(e: any): void {
    ...
    if (dper) {
      this.FFacturas.FECHA_INICIAL = dper.Fecha_Inicio;
      this.FFacturas.FECHA_FINAL = dper.Fecha_Fin;
    }
  }
  ...
  onSeleccCliente(e: any): void {
    ...
    if (dcli) {
      this.FFacturas.NOMBRE = dcli.NOMBRE_COMPLETO;
      ...
      this._sdatos
        ...
        .subscribe((data: any) => {
          ...
          this.FFacturas.ID_PROPIEDAD = res[0].PROPIEDAD;
        });
      ...
      this._sdatos
        ...
        .subscribe((data: any) => {
          ...
          if(this.DDocumentos != null && this.DDocumentos.length == 1 && !this.readOnly){
            this.FFacturas.DOCUMENTO = this.DDocumentos[0].DOCUMENTO;
            this.FFacturas.ID_DOCUMENTO = this.DDocumentos[0].ID_DOCUMENTO;
            this.FFacturas.CONSECUTIVO = this.DDocumentos[0].CONSECUTIVO;
          }
        });
    }
